...
import { greedy_snake_step as snake1 } from './yybzfz/pkg/snake.js';     // yybzfz
import { greedySnakeStep as snake2 } from './t3lzh/lzh-snake/release.js';  // lzh
import { greedy_snake_step as snake3 } from './t3fxk/pkg/t3_rust.js';      // fxk
import { greedy_snake_step as snake4 } from './t3xc/pkg/snake.js';         // xc
import { greedy_snake_step as snake5 } from './t3srz/v3/snake_ai_wasm.js'; // srz
import { greedy_snake_step as snake6 } from './t3cxc/release/release.js';  // cxc
...
// Game mode
export const GAME_MODE = "4v4"; // "1v1" or "4snakes" or "custom"
...
export const CUSTOM_SEED = undefined;
// BigInt("0x8a6aa454ecb7ceee");
